 ...
 */
final class Version20230922083855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD category_id INT DEFAULT NULL, DROP collection');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD collection VARCHAR(255) DEFAULT NULL, DROP category_id');
    }
}
